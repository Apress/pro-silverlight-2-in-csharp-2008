    ...
    {             
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            foreach (UIElement element in this.Children)
            {
                ...
                if ((currentLineSize.Width + desiredSize.Width > constraint.Width) || (WrapPanel.GetLineBreakBefore(element)))
                {                    
        ...
        protected override Size ArrangeOverride(Size arrangeBounds)
        {
            ...
            foreach (UIElement element in this.Children)
            {
                ...
                // Check if the element fits in the line, if given its desired size.
                if ((currentLineSize.Width + desiredSize.Width > arrangeBounds.Width)|| (WrapPanel.GetLineBreakBefore(element)))
                {
                    // Switch to a new line because space has run out.
